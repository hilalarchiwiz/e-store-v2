...
import { deleteWhatWeDo, getWhatWeDo } from "../what-we-do/actions/whatwedo.action";
...
const MissionVisionPage = async (
    ...
    const { whatwedoes, totalPages, totalCount } = await getWhatWeDo(params, 'mission_vision');
        ...
        },
        {
            ...
            accessor: (whatwedo: any) => (
                <div className="flex gap-2">
                    <Link href={`/admin/about/mission-vision/edit/${whatwedo.id}`} className="p-2 bg-blue-50 text-blue-600 rounded">
        ...
        <RoleGuard permission="about_view">
            <div className="w-full">
                ...
                <div className="px-4 py-6">
                    <AddButton title='Add Mission Vision' url='/admin/about/mission-vision/add' />
                    <div className="bg-white rounded-lg overflow-hidden">
                        ...
                        {whatwedoes?.length === 0 ? (
                            ...
                            <>
                                <DataTable data={whatwedoes} columns={missionVisionColumns} />
