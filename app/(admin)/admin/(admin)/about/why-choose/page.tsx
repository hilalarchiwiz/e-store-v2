...
const MissionVisionPage = async (
    ...
    const { whatwedoes, totalPages, totalCount } = await getWhatWeDo(params, 'why_choose');
        ...
        },
        {
            ...
            accessor: (whatwedo: any) => (
                <div className="flex gap-2">
                    <Link href={`/admin/about/why-choose/edit/${whatwedo.id}`} className="p-2 bg-blue-50 text-blue-600 rounded">
        ...
        <RoleGuard permission="about_view">
            <div className="w-full">
                ...
                <div className="px-4 py-6">
                    <AddButton title='Add Mission Vision' url='/admin/about/why-choose/add' />
