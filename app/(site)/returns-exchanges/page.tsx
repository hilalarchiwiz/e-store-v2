      ...
      <div className="max-w-4xl">
        ...
        <div className="grid gap-8">
          ...
          <div className="bg-surface dark:bg-surface p-8 rounded-3xl border border-outline dark:border-outline shadow-sm">
            ...
            <p className="text-muted dark:text-muted leading-relaxed mb-4">
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted dark:text-muted pl-2">
          ...
          <div className="bg-surface dark:bg-surface p-8 rounded-3xl border border-outline dark:border-outline shadow-sm">
            ...
            <p className="text-muted dark:text-muted leading-relaxed">
        ...
        <div className="mt-12 text-center p-8 bg-surface dark:bg-surface rounded-3xl">
          <h3 className="text-xl font-bold text-foreground dark:text-foreground mb-2">Still need help?</h3>
