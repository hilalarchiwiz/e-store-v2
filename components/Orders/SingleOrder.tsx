      ...
      {!smallView && (
        <div className="items-center justify-between border-t border-gray-3 py-5 px-7.5 hidden md:flex">
          ...
          <div className="min-w-[175px]">
            <p className="text-[14px] text-dark">{orderItem.createdAt.toLocaleString()}</p>
          </div>

          <div className="min-w-[128px]">
            <p
              className={`inline-block text-[14px]  py-0.5 px-2.5 rounded-[30px] capitalize ${orderItem.status === "delivered"
          ...
          <div className="min-w-[213px]">
            {
              orderItem.orderItems.map((item: any) => (
                <p className="text-[14px] text-dark">{item.product.title}</p>
              ))
            }
          </div>

          <div className="min-w-[113px]">
            <p className="text-[14px] text-dark">Rs. {orderItem.total}</p>
          </div>
      ...
      {smallView && (
        <div className="block md:hidden">
          <div className="py-4.5 px-7.5">
            ...
            {/* <div className="">
              <p className="text-[14px] text-dark flex items-center">
