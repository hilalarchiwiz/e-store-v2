...
import { removeProductFromCart } from "@/lib/action/home.action";
import toast from "react-hot-toast";
import { discountPrice } from "@/lib/helper";

const SingleItem = ({ item, removeItemFromCart, user }) => {
    ...
    <div className="flex items-center justify-between gap-5">
      <div className="w-full flex items-center gap-6">
        <div className="flex items-center justify-center rounded-[10px] bg-gray-3 max-w-[90px] w-full h-22.5">
          <Image unoptimized src={item.images[0]} alt="product" width={100} height={100} />
        </div>
        ...
        <div>
          ...
          <p className="text-[14px]">Price: Rs. {discountPrice({
            price: item.price,
