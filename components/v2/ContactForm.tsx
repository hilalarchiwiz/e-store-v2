  ...
  return (
    <div className="flex flex-col gap-10 sm:gap-14 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch">
        ...
        <div className="lg:col-span-6 bg-white dark:bg-[#1a251d] p-6 sm:p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 flex flex-col justify-between gap-8 shadow-[0_2px_10px_rgba(0,0,0,0.03)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Call Center */}
            <div className="p-4 rounded-xl border border-neutral-200/70 dark:border-neutral-800 bg-neutral-50/50 dark:bg-[#141f17] flex items-start gap-3.5 shadow-2xs transition-all hover:border-green-500/40">
        ...
        <div className="lg:col-span-6 bg-white dark:bg-[#1a251d] p-6 sm:p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.15)] flex flex-col justify-between">
          {submitted ? (
            ...
            <form action={formAction} className="flex flex-col h-full justify-between gap-5">
              <div>
                ...
                <div className="flex flex-col gap-3.5">
                  {/* Name Input */}
                  <div className="px-3.5 py-3 rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-[#141f17] flex items-center gap-3 focus-within:border-green-600 transition-colors">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="p-3 rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-[#141f17] flex items-start gap-3 focus-within:border-green-600 transition-colors">
                      <textarea
                        name="message"
                        required
                        rows={3}
      ...
      <div className="w-full bg-[#f4f9f5] dark:bg-[#15251a] border border-emerald-200/60 dark:border-emerald-900/40 rounded-2xl p-6 sm:p-8 lg:p-10 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-col gap-3 flex-1">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <div className="px-3.5 py-2.5 rounded-lg bg-white dark:bg-[#141f17] border border-neutral-200/80 dark:border-neutral-800 text-neutral-700 dark:text-neutral-300 text-xs sm:text-sm font-semibold flex items-center gap-2 shadow-2xs">
