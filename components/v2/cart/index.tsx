      ...
      {loading ? (
        <div className="flex flex-col gap-4">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="bg-surface dark:bg-surface border border-outline dark:border-outline rounded-2xl p-6 h-32 animate-pulse"
            />
          ))}
        </div>
      ) : items.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="md:col-span-6 flex items-center gap-5">
                        <div className="size-24 rounded-2xl overflow-hidden bg-icon-surface dark:bg-icon-surface shrink-0 relative">
                          <Image
                            src={
                      ...
                      <div className="md:col-span-2 text-center">
                        ...
                        <p className="font-extrabold text-foreground dark:text-foreground">
                      ...
                      <div className="md:col-span-2 flex justify-center">
                        <div className="flex flex-col items-center">
                          <span className="md:hidden text-xs font-bold text-muted mb-2">
                            Qty
                          </span>
                          <div className="flex items-center bg-surface dark:bg-white/5 rounded-xl border border-outline dark:border-white/10 px-2 py-1">
                            <button
          ...
          <div className="lg:col-span-4">
            <div className="bg-surface dark:bg-surface rounded-2xl border border-primary/5 shadow-xl p-6 sm:p-7">
              <h2 className="text-xl font-bold text-foreground dark:text-foreground mb-5">
                Order Summary
              </h2>
              ...
              <div className="space-y-2 mb-5">
                <div className="flex justify-between items-center text-sm font-semibold">
                  ...
                  <span className="text-foreground dark:text-foreground whitespace-nowrap font-bold">
              ...
              <div className="border-t border-outline dark:border-white/5 pt-4 mb-6">
