      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
        ...
        <div className="flex flex-col gap-4 sm:gap-5">
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
            <div className="flex flex-col">
              ...
              <span className="text-2xl sm:text-3xl md:text-4xl font-black text-primary whitespace-nowrap">
                PKR {Number(displayPrice).toLocaleString()}
              </span>
            </div>
            {hasDiscount && (
              <span className="bg-red-500 text-white text-[10px] font-black uppercase tracking-tighter px-2.5 py-1 rounded-lg shadow-lg shadow-red-500/20 animate-pulse whitespace-nowrap">
        ...
        ${showShare
            ...
            <button
              ...
              className="w-full sm:flex-1 h-12 sm:h-14 flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#20bd5a] hover:shadow-lg hover:shadow-green-500/25 active:scale-[0.98] text-white font-black rounded-xl transition-all group"
            >
          ...
          <div className="rounded-2xl border border-[#25D366]/30 bg-[#25D366]/5 p-4 sm:p-5">
            ...
            <div className="mt-3 flex flex-col-reverse gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-xl bg-[#25D366] px-5 text-xs font-black uppercase tracking-wider text-white transition-all hover:bg-[#20bd5a] hover:shadow-lg hover:shadow-green-500/20 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:shadow-none"
              >
