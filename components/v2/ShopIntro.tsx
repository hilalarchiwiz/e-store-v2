            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`group relative flex h-27 w-34 shrink-0 snap-start flex-col items-center justify-between overflow-hidden rounded-lg border bg-surface px-3 pb-2.5 pt-3 shadow-[0_2px_7px_rgba(15,23,42,0.10)] transition-all hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-md dark:bg-surface sm:h-30 sm:w-40 ${
                    isSelected
                ...
                >
                  ...
                  <div className="mt-1 flex max-w-full items-center gap-1.5">
                    <h2 className="truncate text-center text-xs font-semibold text-foreground transition-colors group-hover:text-primary dark:text-foreground sm:text-sm">
                      {category.title}
                    </h2>
                  </div>
                </button>
