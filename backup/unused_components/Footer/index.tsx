...
const Footer = async ({ footer_setting }) => {
          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                {footer_setting?.setting?.home_address_location}
              </li>
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5">
                  ...
                  {footer_setting?.setting?.home_number}
                </a>
              </li>
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5">
                  ...
                  {footer_setting?.setting?.support_email}
                </a>
              </li>
            </ul>
            ...
            <ul className="flex flex-col gap-3">
              {
                pages && pages.map((page) => (
                  <li key={page.id}>
                    <Link className="ease-out duration-200 hover:text-blue" href={page.slug}>
                      {page.title}
                    </Link>
                  </li>
                ))
              ...
              <li>
                <Link className="ease-out duration-200 hover:text-blue" href="/blogs">
                  Blog
                </Link>
              </li>
              <li>
        ...
        <div className=" max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. {footer_setting?.setting?.footer_text}
            </p>
