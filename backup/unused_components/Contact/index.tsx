          ...
          <div className="flex flex-col xl:flex-row gap-7.5">
            ...
            <div className="xl:max-w-[770px] w-full bg-white rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
              <HomeFormWrapper
                action={contact}
                href="/contact"
                successMessage="Contact add successfully"
              >
                ...
                <button
                  type="submit"
                  className="inline-flex font-medium text-white bg-blue-dark py-3 px-7 rounded-md ease-out duration-200 hover:bg-[#25a953]"
                >
                  Send Message
                </button>
              </HomeFormWrapper>
