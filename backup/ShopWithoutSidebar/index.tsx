...
const ShopWithoutSidebar = ({ products, totalPages, currentPage, totalCount }) => {
                  ...
                  <div className="rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex flex-wrap items-center gap-4">
                        ...
                        <p>
                          Showing <span className="text-dark">{products.length} of {totalCount}</span> Products
                        </p>
                      </div>
                      ...
                      <div className="flex items-center gap-2.5">
                        <button
                          ...
                          className={`${productStyle === "grid"
                            ...
                            } flex items-center justify-center w-10.5 h-9 rounded-[5px] border ease-out duration-200 hover:bg-[#25a953] hover:border-[#25a953] hover:text-white`}
                        >
                          <svg
                        ...
                        <button
                          ...
                          className={`${productStyle === "list"
                            ? "bg-blue-dark border-blue-dark text-white"
                            : "text-dark bg-gray-1 border-gray-3"
                            } flex items-center justify-center w-10.5 h-9 rounded-[5px] border ease-out duration-200 hover:bg-blue-dark hover:border-[#25a953] hover:text-white`}
                        >
                          <svg
                            className="fill-current"
                            width="18"
